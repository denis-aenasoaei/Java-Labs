...
@NamedQueries({
    ...
    @NamedQuery(name = "Album.findByArtist", query = "SELECT a from ALBUM a where artist_id = :artist_id")})
public class Album implements Serializable {
    ...
    public Album(BigDecimal id, String name, BigInteger releaseYear, Artist artistId) {
        this.id = id;
        this.name = name;
